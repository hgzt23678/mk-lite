...
r.prototype = {
	...
	if (e(t) == "object") {
		var i = {};
		for (var a in t) t.hasOwnProperty(a) && (i[a] = a === "a" ? t[a] : F(t[a]));
		t = i;
	}
	return r(t, n);
};
...
//#endregion
//#region ../../tools/tag-cloud-browser-entry.mjs
var H = "/client-assets/tagcanvas.min.js";
function U() {
	return new Promise((e) => {
		if (window.TagCanvas !== void 0) {
			e(!0);
			return;
		}
		let t = document.createElement("script");
		t.async = !0, t.src = H, t.addEventListener("load", () => e(window.TagCanvas !== void 0)), t.addEventListener("error", () => e(!1)), document.head.appendChild(t);
	});
}
async function W(e, t, n) {
	...
	let o = document.getElementById(e), s = document.getElementById(t);
	if (!(o instanceof HTMLCanvasElement) || !(s instanceof HTMLElement)) return {
		update() {},
		dispose() {}
	};
	o.width = n instanceof HTMLElement ? n.offsetWidth : 300;
	let c = getComputedStyle(document.documentElement).getPropertyValue("--accent");
	return window.TagCanvas.Start(e, t, {
		textColour: "#ffffff",
		outlineColour: r(c).toHexString(),
		outlineRadius: 10,
		initial: [-.03, -.01],
		frontSelect: !0,
		imageRadius: 8,
		...
		update() {
			window.TagCanvas && window.TagCanvas.Update(e);
		},
		dispose() {
			i = !0, window.TagCanvas && window.TagCanvas.Delete(e);
		}
	};
}
//#endregion
