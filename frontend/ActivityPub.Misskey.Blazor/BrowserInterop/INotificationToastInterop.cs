...
public interface INotificationToastInterop : IAsyncDisposable
{
...
public sealed class NotificationToastInterop(IJSRuntime javascript) : INotificationToastInterop
{
    private readonly Lazy<Task<IJSObjectReference>> module = new(() =>
        BrowserModuleImporter.ImportAsync(
            javascript,
            "./_content/ActivityPub.Misskey.Blazor/js/notification-toast.js"));
