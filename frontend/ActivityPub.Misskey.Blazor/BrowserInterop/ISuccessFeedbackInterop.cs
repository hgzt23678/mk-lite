...
public interface ISuccessFeedbackInterop : IAsyncDisposable
{
...
public sealed class SuccessFeedbackInterop(IJSRuntime javascript) : ISuccessFeedbackInterop
{
    private readonly Lazy<Task<IJSObjectReference>> module = new(() =>
        BrowserModuleImporter.ImportAsync(
            javascript,
            "./_content/ActivityPub.Misskey.Blazor/js/success-feedback.js"));
