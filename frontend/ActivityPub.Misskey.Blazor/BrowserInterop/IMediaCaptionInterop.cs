...
public interface IMediaCaptionInterop : IAsyncDisposable
{
...
public sealed class MediaCaptionInterop(IJSRuntime javascript) : IMediaCaptionInterop
{
    private readonly Lazy<Task<IJSObjectReference>> module = new(() =>
        BrowserModuleImporter.ImportAsync(
            javascript,
            "./_content/ActivityPub.Misskey.Blazor/js/media-caption.js"));
