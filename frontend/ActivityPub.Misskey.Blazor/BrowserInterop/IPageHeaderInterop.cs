...
public interface IPageHeaderInterop : IAsyncDisposable
{
...
public sealed class PageHeaderInterop(IJSRuntime javascript) : IPageHeaderInterop
{
    private readonly Lazy<Task<IJSObjectReference>> module = new(() =>
        BrowserModuleImporter.ImportAsync(
            javascript,
            "./_content/ActivityPub.Misskey.Blazor/js/page-header.js"));
